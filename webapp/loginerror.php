<!-- start session and include all methods-->
<?php
      ...
      <div class="media">
        ...
        <div class="media-body">
          <h4 class="media-heading"> Welcome! </h4>
            ...
            <p>Here you can log-in to the site:<p>
              <div class="row-fluid">
                <div class="span5">
                </div>
                <div class="span5">
	    ...
	    <?php
                echo "There was an issue trying to login. Did you put in the right username or password? Please try again";
	      ?>
	      		<br>
